...
const About = () => {
  return (
    <section className={aboutStyles.About}>
      ...
      <Blog image={sectionCat} alt="kot-sekcja" title="Poznaj historię naszych pacjentów" paragraph="Blog przeznaczony dla pasjonatów weterynarii." blogtext="zobacz blog" />
    </section>
  );
};
